...
#===============================================================================
#
#          FILE: iptables_rules_dynamic.sh
# 
#         USAGE: ./iptables_rules_dynamic.sh 
# 
#   DESCRIPTION: 
# 
#       OPTIONS: ---
...
#Useg example
#DNS_NAME "akamai.bintray.com jcenter.bintray.com maven.fabric.io fabric.io crashlytics.com repo.maven.apache.org google.com updates.jenkins-ci.org repo.us-west-1.amazonaws.com pkg.jenkins-ci.org ftp-chi.osuosl.org services.gradle.org downloads.gradle.org s3.amazonaws.com repo.jfrog.org fastdl.mongodb.org distribution-uploads.crashlytics.com services.gradle.org cm.crashlytics.com ec2-54-219-126-252.us-west-1.compute.amazonaws.com ec2-54-176-78-3.us-west-1.compute.amazonaws.com ec2-54-215-89-219.us-west-1.compute.amazonaws.com ec2-54-219-59-164.us-west-1.compute.amazonaws.com jenkins-matrixx.waverleysoftware.com"
#ALLOWED_PORTS="22 25 80 443 465 563 873 2200 8080 8081 9418 39066 39966 41856"
...
WG_IPs="178.172.239.240 178.172.239.241 178.172.239.242 178.172.239.243 178.172.239.244 178.172.239.245 178.172.239.246 178.172.239.247 178.172.239.248 178.172.239.249 178.172.239.250"

for WG_IP in $WG_IPs; do
echo "Permitting WG Office $WG_IP"
$IPTABLES -I INPUT -s $WG_IP -j ACCEPT
$IPTABLES -I OUTPUT -d $WG_IP -j ACCEPT
done
